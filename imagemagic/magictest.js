...
(function() {
  var allowedImageFormats, client, findOrDownloadImageFile, fs, getFilenameWithoutExtension, getHeightFromWidthUsingAspectRatio, getImageFormatFromFilename, getOriginalImageData, http, im, localKittens, path, redis, remoteFile, remoteFile2, resizeImage, saveResizeDataToRedis, stripDimensionsFromSourceImageName, timeStarted,
  ...
  saveResizeDataToRedis = function(oi, ri, existingData) {
    var key, lastFowardSlash, originalFile, resizeData, val;
    if (existingData == null) {
      existingData = {};
    }
  ...
  findOrDownloadImageFile(remoteFile, 0, 450, function(localFilename) {
    console.log("Local Filename: " + localFilename);
    return getOriginalImageData(localFilename, 0, 450, function(oi, ri) {
  ...
  findOrDownloadImageFile(localKittens, 0, 600, function(localFilename) {
    console.log("Local Filename: " + localFilename);
    return getOriginalImageData(localFilename, 0, 600, function(oi, ri) {
      return resizeImage(oi, ri);
    });
  });
  ...
  findOrDownloadImageFile(remoteFile2, 0, 200, function(localFilename) {
    console.log("Local Filename: " + localFilename);
